...
```bash
export COMPANY_LOCATION=$COMPANY_LOCATION
export STORAGE_KEY=$STORAGE_KEY
export COMPANY_PG_SERVER_NAME=$COMPANY_PG_SERVER_NAME
export COMPANY_PG_USER=$COMPANY_PG_USER
export COMPANY_PG_PASSWORD=$COMPANY_PG_PASSWORD
export COMPANY_PG_BD_NAME=$COMPANY_PG_BD_NAME
export COMPANY_PG_PORT=$COMPANY_PG_PORT
export COMPANY_STORAGE_ACCOUNT_NAME=$COMPANY_STORAGE_ACCOUNT_NAME

export COMPANY_CONTAINER_REGISTRY_NAME=$COMPANY_CONTAINER_REGISTRY_NAME
...
echo $STORAGE_KEY
echo $COMPANY_PG_SERVER_NAME
echo $COMPANY_PG_USER
echo $COMPANY_PG_PASSWORD
echo $COMPANY_PG_BD_NAME
echo $COMPANY_PG_PORT
echo $COMPANY_STORAGE_ACCOUNT_NAME
echo $COMPANY_CONTAINER_REGISTRY_NAME
echo $ACR_USERNAME
echo $ACR_PASSWORD
echo $WORKSPACE_ID
echo $WORKSPACE_KEY
echo $COMPANY_PG_HOST 
```
